                ...
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-2">Total Price
                                            ...
                                            <a href="/purchase/{{ $order->order_id }}"
                                                class="text-decoration-none badge bg-primary mt-2"
                                                data-feather="eye">Detail</a>
                    ...
                    @else
                        <div class="text-center">
                            <a href="/clothes" class="text-decoration-none text-dark">
                                <h1>Please place an order here</h1>
                            </a>
